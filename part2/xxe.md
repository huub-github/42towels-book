...
_Note that both XXE challenges described below are
**not available** because the 42 Towels Shop runs on a Heroku dyno! 
Certain aggressive attacks against the
